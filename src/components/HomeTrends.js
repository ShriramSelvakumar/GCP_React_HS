...
const HomeTrends = ({loginOnly, sessionKey}) => {
    ...
    const fetchTweets = async (count, lang, query) => {
        ...
        const res = await fetch('https://django2-336605.ey.r.appspot.com/search_tweets/', {
          method: 'POST',
          body: formData,
        })
      ...
      const exportTweets = async (val) => {
        const res = await fetch('https://django2-336605.ey.r.appspot.com/export_tweets/', {
          method: 'POST',
      ...
      const blockUsers = async (val) => {
        const res = await fetch('https://django2-336605.ey.r.appspot.com/block_users_json/', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
      ...
      const muteUsers = async (val) => {
        const res = await fetch('https://django2-336605.ey.r.appspot.com/mute_users_json/', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({session_key: sessionKey, name: tweets.screen_name,
                              ml_prediction: tweets.prediction,
